...
def write_icc_results(all_subject_data):
    ...
    for subject in all_subject_data:
        d1_dom_r2 = calculate_r2(subject.day1_dominant.ACTUAL, subject.day1_dominant.PERCEIVED)
        d2_dom_r2 = calculate_r2(subject.day2_dominant_1.ACTUAL, subject.day2_dominant_1.PERCEIVED)
